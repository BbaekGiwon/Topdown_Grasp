...
FIXED_JOINT_ANGLES_DRO: list[float] = [
    -_abd,     _fi_bend_g, _fi_bend_g, _fi_bend_g,  # index  (0-3)
     _z,       _fi_bend_g, _fi_bend_g, _fi_bend_g,  # middle (4-7)
     _abd,     _fi_bend_g, _fi_bend_g, _fi_bend_g,  # ring   (8-11)
    _th_j1_g, _th_j2_g,   _fi_bend_g, _fi_bend_g,  # thumb  (12-15)
]
